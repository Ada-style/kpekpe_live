...
const SCHOOLS_DB = [
    ...
    { name: "DEFITECH", type: "Privé", ville: "Lomé", domaines: ["Informatique", "Réseaux", "Télécoms"] },
    { name: "ESAG-NDE", type: "Privé", ville: "Lomé", domaines: ["Gestion", "Commerce", "Administration"] },
    { name: "ISDI", type: "Privé", ville: "Lomé", domaines: ["Droit", "Administration"] },
    { name: "ESTABAT", type: "Privé", ville: "Lomé", domaines: ["BTP", "Topographie", "Génie Civil"] },
    { name: "ESAMOD", type: "Privé", ville: "Lomé", domaines: ["Mode", "Stylisme", "Couture"] },
    { name: "EMARITO", type: "Privé", ville: "Lomé", domaines: ["Logistique", "Maritime", "Transit"] },
    { name: "CFBT", type: "Privé", ville: "Lomé", domaines: ["Banque", "Finance"] },
...
const JOBS_DATA = [
    ...
    { id: "dev_web", title: "Développeur Full-Stack", category: "Numérique", tags: ["informatique", "code", "internet", "création", "logique", "programmation", "développement", "web"], profiles: ["ANALYTIQUE", "CREATIF"], series: ["C", "E", "TI/1", "F2"], studies: "2-5 ans", recruiters: ["Startups (Lomé)", "Gozem", "Semoa"], desc: "Créer des sites et applis.", salary_indice: "Élevé" },
    { id: "data_analyst", title: "Data Analyst", category: "Numérique", tags: ["données", "chiffres", "maths", "analyse", "informatique", "programmation"], profiles: ["ANALYTIQUE", "METHODIQUE"], series: ["C", "E"], studies: "3-5 ans", recruiters: ["Togocom", "Moov Africa", "Banques"], desc: "Analyse des données.", salary_indice: "Élevé" },
    { id: "cybersecurite", title: "Expert Cyber-sécurité", category: "Numérique", tags: ["sécurité", "informatique", "code", "réseaux", "protection", "programmation"], profiles: ["ANALYTIQUE", "METHODIQUE"], series: ["C", "E", "TI/1"], studies: "5 ans", recruiters: ["Banques", "État (CINA)"], desc: "Protection des systèmes.", salary_indice: "Élevé" },
    ...
    { id: "comptable", title: "Comptable / Auditeur", category: "Gestion", tags: ["chiffres", "argent", "gestion", "rigueur", "maths"], profiles: ["METHODIQUE", "ANALYTIQUE"], series: ["G2", "C"], studies: "2-5 ans", recruiters: ["Toutes entreprises", "OTR"], desc: "Gestion des finances.", salary_indice: "Moyen" },
    { id: "commercial", title: "Responsable Commercial", category: "Commerce", tags: ["vente", "négociation", "client", "parler", "argent", "business"], profiles: ["SOCIAL", "ANALYTIQUE"], series: ["G3", "A4"], studies: "3 ans", recruiters: ["Distribution", "Banques", "Togocom"], desc: "Développement des ventes.", salary_indice: "Moyen à Élevé" },
    { id: "logisticien", title: "Expert Logistique Maritime", category: "Transport", tags: ["port", "marchandise", "organisation", "voyage", "géographie"], profiles: ["METHODIQUE", "ANALYTIQUE"], series: ["G3", "C"], studies: "3-5 ans", recruiters: ["PAL (Port)", "AGL (Bolloré)", "MSC"], desc: "Gestion des flux portuaires.", salary_indice: "Élevé" },
    { id: "enseignant", title: "Enseignant / Professeur", category: "Éducation", tags: ["école", "transmettre", "aider", "savoir", "social", "histoire", "géographie"], profiles: ["SOCIAL", "METHODIQUE"], series: ["Toutes"], studies: "3-5 ans", recruiters: ["ENS", "Établissements publics/privés"], desc: "Formation des jeunes.", salary_indice: "Moyen" },
    { id: "rh", title: "Responsable RH", category: "Gestion", tags: ["social", "recrutement", "humain", "entreprise", "aider"], profiles: ["SOCIAL", "METHODIQUE"], series: ["A4", "G1"], studies: "3-5 ans", recruiters: ["Grandes entreprises", "ONG"], desc: "Gestion du personnel.", salary_indice: "Moyen" },
    { id: "banquier", title: "Gestionnaire de Compte", category: "Banque", tags: ["argent", "client", "banque", "finance", "confiance"], profiles: ["SOCIAL", "METHODIQUE"], series: ["G2", "C", "A4"], studies: "3 ans", recruiters: ["Orabank", "Ecobank", "BOAD"], desc: "Conseils financiers clients.", salary_indice: "Moyen" },
